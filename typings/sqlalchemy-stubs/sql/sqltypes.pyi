...
import decimal
import enum
from typing import Any, Callable, Dict, List, Optional, Sequence, TYPE_CHECKING, Tuple, Type, TypeVar, Union, overload
from uuid import UUID as _python_UUID
from . import type_api
from .base import SchemaEventTarget
from .cache_key import HasCacheKey
from .elements import ColumnElement
from .type_api import Emulated, NativeForEmulated, TypeDecorator as TypeDecorator, TypeEngine as TypeEngine, TypeEngineMixin, _BindProcessorType, _ComparatorFactory, _LiteralProcessorType, _ResultProcessorType
from .. import util
...
class Indexable(TypeEngineMixin):
    ...
    class Comparator(TypeEngine.Comparator[_T]):
        __slots__ = ...
        def __getitem__(self, index): # -> ColumnElement:
            ...
...
class Numeric(HasExpressionLookup, TypeEngine[_N]):
    ...
    @overload
    def __init__(self: Numeric[decimal.Decimal], precision: Optional[int] = ..., scale: Optional[int] = ..., decimal_return_scale: Optional[int] = ..., asdecimal: Literal[True] = ...) -> None:
        ...
    
    @overload
    def __init__(self: Numeric[float], precision: Optional[int] = ..., scale: Optional[int] = ..., decimal_return_scale: Optional[int] = ..., asdecimal: Literal[False] = ...) -> None:
        ...
    
    def __init__(self, precision: Optional[int] = ..., scale: Optional[int] = ..., decimal_return_scale: Optional[int] = ..., asdecimal: bool = ...) -> None:
        """
        Construct a Numeric.
    ...
    def bind_processor(self, dialect): # -> Callable[..., float | None] | None:
        ...
    
    def result_processor(self, dialect, coltype): # -> Callable[[float | None], Decimal | None] | Callable[..., float | None] | None:
        ...
...
class Float(Numeric[_N]):
    ...
    if not TYPE_CHECKING:
        ...
    @overload
    def __init__(self: Float[float], precision: Optional[int] = ..., asdecimal: Literal[False] = ..., decimal_return_scale: Optional[int] = ...) -> None:
        ...
    
    @overload
    def __init__(self: Float[decimal.Decimal], precision: Optional[int] = ..., asdecimal: Literal[True] = ..., decimal_return_scale: Optional[int] = ...) -> None:
        ...
    
    def __init__(self: Float[_N], precision: Optional[int] = ..., asdecimal: bool = ..., decimal_return_scale: Optional[int] = ...) -> None:
        r"""
        Construct a Float.
...
class _Binary(TypeEngine[bytes]):
    ...
    def result_processor(self, dialect, coltype): # -> Callable[..., bytes | None] | None:
        ...
    
    def coerce_compared_value(self, op, value): # -> Self | TypeEngine[Any]:
...
class SchemaType(SchemaEventTarget, TypeEngineMixin):
    ...
    def copy(self, **kw): # -> TypeEngine[Any]:
        ...
...
class Enum(String, SchemaType, Emulated, TypeEngine[Union[str, enum.Enum]]):
    ...
    @property
    def sort_key_function(self): # -> Callable[..., str | None] | Any:
        ...
    ...
    def as_generic(self, allow_nulltype=...): # -> TypeEngine[str]:
        ...
    
    def adapt_to_emulated(self, impltype, **kw): # -> TypeEngineMixin | TypeEngine[Any]:
        ...
    
    def adapt(self, cls, **kw):
        ...
    
    def literal_processor(self, dialect): # -> Callable[..., Any | str | None]:
        ...
    
    def bind_processor(self, dialect): # -> Callable[..., Any | str | None]:
        ...
    
    def result_processor(self, dialect, coltype): # -> Callable[..., str | Enum]:
        ...
    ...
    @property
    def python_type(self): # -> type[Enum] | type[str]:
        ...
...
class PickleType(TypeDecorator[object]):
    ...
    def __reduce__(self): # -> tuple[type[PickleType], tuple[int, None, Callable[[Any, Any], bool] | None]]:
        ...
    
    def bind_processor(self, dialect): # -> Callable[..., Any] | Callable[..., bytes | Any | None]:
        ...
    
    def result_processor(self, dialect, coltype): # -> Callable[..., Any | None]:
        ...
    
    def compare_values(self, x, y): # -> bool | Any:
        ...
...
class Boolean(SchemaType, Emulated, TypeEngine[bool]):
    ...
    def result_processor(self, dialect, coltype): # -> Callable[..., bool | None] | None:
        ...
...
class Interval(Emulated, _AbstractInterval, TypeDecorator[dt.timedelta]):
    ...
    def adapt_to_emulated(self, impltype, **kw): # -> TypeEngine[Any]:
        ...
...
class JSON(Indexable, TypeEngine[Any]):
    ...
    **Customizing the JSON Serializer**
    ...
    class Comparator(Indexable.Comparator[_T], Concatenable.Comparator[_T]):
        ...
        __slots__ = ...
        type: JSON
        def as_boolean(self): # -> BinaryExpression[_T]:
        ...
        def as_string(self): # -> BinaryExpression[_T]:
        ...
        def as_integer(self): # -> BinaryExpression[_T]:
        ...
        def as_float(self): # -> BinaryExpression[_T]:
        ...
        def as_numeric(self, precision, scale, asdecimal=...): # -> BinaryExpression[_T]:
        ...
        def as_json(self): # -> ColumnElement[_T]:
...
class ARRAY(SchemaEventTarget, Indexable, Concatenable, TypeEngine[Sequence[_T]]):
    ...
    * When used with the Python ``getitem`` accessor, the number of dimensions
    ...
    _is_array = ...
    zero_indexes = ...
    def __init__(self, item_type: _TypeEngineArgument[_T], as_tuple: bool = ..., dimensions: Optional[int] = ..., zero_indexes: bool = ...) -> None:
    ...
    class Comparator(Indexable.Comparator[Sequence[_CT]], Concatenable.Comparator[Sequence[_CT]]):
        ...
        def any(self, other: Any, operator: Optional[OperatorType] = ...) -> ColumnElement[bool]:
        ...
        @util.preload_module("sqlalchemy.sql.elements")
        def all(self, other: Any, operator: Optional[OperatorType] = ...) -> ColumnElement[bool]:
...
class Uuid(Emulated, TypeEngine[_UUID_RETURN]):
    ...
    **Python uuid objects**, from the Python
    ...
    @overload
    def __init__(self: Uuid[_python_UUID], as_uuid: Literal[True] = ..., native_uuid: bool = ...) -> None:
        ...
    
    @overload
    def __init__(self: Uuid[str], as_uuid: Literal[False] = ..., native_uuid: bool = ...) -> None:
        ...
    ...
    @property
    def python_type(self): # -> type[UUID] | type[str]:
        ...
    ...
    def result_processor(self, dialect, coltype): # -> Callable[..., UUID | None] | Callable[..., str | None] | None:
        ...
...
class UUID(Uuid[_UUID_RETURN], type_api.NativeForEmulated):
    ...
    __visit_name__ = ...
    @overload
    def __init__(self: UUID[_python_UUID], as_uuid: Literal[True] = ...) -> None:
        ...
    
    @overload
    def __init__(self: UUID[str], as_uuid: Literal[False] = ...) -> None:
        ...
...
_type_map_get = ...
INDEXABLE = type_api.INDEXABLE = Indexable
